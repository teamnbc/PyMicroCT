...
if __name__ == '__main__':
    # Drawing functions and related classes are in customROI.py
    #
    #   1. Define paths
    ...
    for debugging
    # import cv2, time, roi
    # im_top=cv2.imread('/home/ghyomm/DATA_MICROCT/SPINE/20190702_SPINE/S1833_01_Colonne_110140/analysis/images/projection_top.png',0)
    """
    ...
    # # Save object ROI in file
    # if not os.path.exists(im_path):
    #     os.makedirs(im_path)
    # destfile = open(os.path.join(analysis_path, 'ROI.pickle'), 'ab')
    # pickle.dump(ROI,destfile)
    # destfile.close()
    #
    ###################################################################################################################
